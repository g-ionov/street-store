...
(function ($, window, document) {
    ...
    // let $starWidthForExistingReview = $('#review-stars')
    // let $reviewGrade = $('#review-grade');
    ...
    const ratingStarsControl = function () {
        ...
        // let currentValForExistingReview = parseFloat($reviewGrade.val());
        // let newStarWidthForExistingReview = Math.floor(oneStarWidth * currentValForExistingReview);
        // $starWidthForExistingReview.css('width', newStarWidthForExistingReview);
        ...
        $ratingField.on('change', function () {
            ...
            if (!currentVal || currentVal === '' || currentVal === 'NaN' || currentVal === 0) {
                ...
                if ((currentVal >= 0) && (currentVal <= ratingthresholdNumber)) {
